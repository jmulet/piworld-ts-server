(function(){
var module = angular.module("PasswordStrength", []);

// This algorithm is inspired by the rules on http://www.passwordmeter.com
module.factory('PasswordStrength', function () {
    'use strict';
...
module.directive('ngPasswordStrength', ['$compile', 'PasswordStrength', function ($compile, passwordStrength) {
