...
fxPickList.$inject = ["$compile", "$templateCache"];
...
fxPickListForm.$inject = ["$compile", "$templateCache"];
...
fxPickListSrc.$inject = ["$compile", "$templateCache"];
...
fxPickListDest.$inject = ["$compile", "$templateCache"];
